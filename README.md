...
| **TrueCrypt / VeraCrypt** | Эвристический анализ: размер кратен 512 байтам, энтропия Шеннона > 7.99 бит/байт, критерий хи-квадрат в диапазоне 190–325, отсев известных сигнатур через Tyfe |
